...
async function register (server, options) {
  ...
  const graphiOptions = {
    ...
    graphiAuthStrategy: options.graphiAuthStrategy
  };
  ...
  server.ext('onPostAuth', restrictAdminArea);
}
...
async function restrictAdminArea (request, h) {
  if (request.route.path !== '/graphiql') {
    return h.continue;
  }
